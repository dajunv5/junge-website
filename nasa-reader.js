...
if(_devUnlocked)return;
if(e.key==='F12'||(e.ctrlKey&&e.shiftKey&&['I','i','J','j','C','c'].includes(e.key))||(e.ctrlKey&&(e.key==='u'||e.key==='U'||e.key==='s'||e.key==='S')))e.preventDefault();
});
}
...
words:[{en:'Earth system',cn:'地球系统'},{en:'geosphere',cn:'岩石圈'},{en:'hydrosphere',cn:'水圈'},{en:'atmosphere',cn:'大气圈'},{en:'biosphere',cn:'生物圈'}],
text:[
...
words:[{en:'mountain',cn:'山'},{en:'volcano',cn:'火山'},{en:'erosion',cn:'侵蚀'},{en:'mineral',cn:'矿物'},{en:'soil',cn:'土壤'}],
text:[
...
words:[{en:'ocean',cn:'海洋'},{en:'river',cn:'河流'},{en:'glacier',cn:'冰川'},{en:'evaporation',cn:'蒸发'},{en:'water cycle',cn:'水循环'}],
text:[
{en:'Anita steps forward gracefully. Oh really, Simon? What about me, the Hydrosphere?',cn:'安妮塔优雅地走上前来。哦，是吗，西蒙？那我呢，水圈呢？'},
{en:'Water covers most of the Earth surface. Oceans, rivers, lakes, and even ice - they are all part of me.',cn:'水覆盖了地球表面的大部分。海洋、河流、湖泊，甚至冰——它们都是我的一部分。'},
...
words:[{en:'oxygen',cn:'氧气'},{en:'weather',cn:'天气'},{en:'greenhouse effect',cn:'温室效应'},{en:'wind',cn:'风'},{en:'protect',cn:'保护'}],
text:[
...
{en:'I protect the Earth from the Sun harmful rays. I keep the planet warm enough to live on.',cn:'我保护地球免受太阳有害射线的伤害。我让地球保持足够温暖来维持生命。'},
...
words:[{en:'energy',cn:'能量'},{en:'photosynthesis',cn:'光合作用'},{en:'food chain',cn:'食物链'},{en:'habitat',cn:'栖息地'},{en:'sunlight',cn:'阳光'}],
text:[
...
{en:'Plants capture the Sun energy through photosynthesis. Animals eat plants. The energy flows through the food chain.',cn:'植物通过光合作用捕获太阳的能量。动物吃植物。能量沿着食物链流动。'},
...
words:[{en:'connected',cn:'相连的'},{en:'interact',cn:'相互作用'},{en:'balance',cn:'平衡'},{en:'system',cn:'系统'},{en:'together',cn:'一起'}],
text:[
...
{en:'And everything needs the Sun energy to keep going.',cn:'而一切都需要太阳的能量才能持续运转。'},
...
words:[{en:'cloud',cn:'云'},{en:'sky',cn:'天空'},{en:'observe',cn:'观察'},{en:'shape',cn:'形状'},{en:'altitude',cn:'高度'}],
text:[
...
{en:'And that one looks like a horse tail, says Simon, pointing at a thin, wispy cloud high above.',cn:'那朵看起来像马尾巴，西蒙指着一朵高高飘浮的纤细云彩说。'},
...
words:[{en:'cirrus',cn:'卷云'},{en:'wispy',cn:'纤细的'},{en:'ice crystal',cn:'冰晶'},{en:'high altitude',cn:'高海拔'},{en:'mare tail',cn:'马尾云'}],
text:[
{en:'The highest clouds are called cirrus clouds. The word cirrus means curl of hair.',cn:'最高的云叫做卷云。卷云这个词的意思是一缕头发。'},
{en:'Cirrus clouds look like thin, wispy strands - like a horse tail blowing in the wind.',cn:'卷云看起来像细细的、轻柔的丝线——就像在风中飘动的马尾巴。'},
...
words:[{en:'cumulus',cn:'积云'},{en:'puffy',cn:'蓬松的'},{en:'cauliflower',cn:'花菜'},{en:'fair weather',cn:'好天气'},{en:'convect',cn:'对流'}],
text:[
{en:'Cumulus clouds are the puffy, white clouds that look like cotton balls or cauliflower.',cn:'积云是蓬松的白云，看起来像棉花球或花菜。'},
{en:'The word cumulus means heap or pile in Latin. These clouds are piled up with flat bottoms.',cn:'积云这个词在拉丁语中是堆的意思。这些云堆叠起来，底部平坦。'},
...
words:[{en:'stratus',cn:'层云'},{en:'layer',cn:'层'},{en:'blanket',cn:'毯子'},{en:'overcast',cn:'阴天'},{en:'fog',cn:'雾'}],
text:[
{en:'Stratus clouds form a flat, gray layer across the sky, like a blanket covering everything.',cn:'层云在天空中形成一层平坦的灰色，像一条毯子覆盖着一切。'},
{en:'The word stratus means layer. These clouds often cover the whole sky on an overcast day.',cn:'层云这个词的意思是层。在阴天，这些云经常覆盖整个天空。'},
...
words:[{en:'nimbus',cn:'雨云'},{en:'cumulonimbus',cn:'积雨云'},{en:'nimbostratus',cn:'雨层云'},{en:'thunderstorm',cn:'雷暴'},{en:'lightning',cn:'闪电'}],
text:[
...
words:[{en:'contrail',cn:'航迹云'},{en:'airplane',cn:'飞机'},{en:'exhaust',cn:'排气'},{en:'persistent',cn:'持续的'},{en:'spread',cn:'扩散'}],
text:[
...
words:[{en:'International Space Station',cn:'国际空间站'},{en:'orbit',cn:'轨道'},{en:'astronaut',cn:'宇航员'},{en:'laboratory',cn:'实验室'},{en:'microgravity',cn:'微重力'}],
text:[
...
words:[{en:'solar array',cn:'太阳能电池板'},{en:'module',cn:'舱段'},{en:'truss',cn:'桁架'},{en:'radiator',cn:'散热器'},{en:'robotic arm',cn:'机械臂'}],
text:[
...
{en:'Canada robotic arm can move people, equipment, and even spacecraft around the station!',cn:'加拿大的机械臂可以在空间站周围移动人员、设备，甚至航天器！'}
]},
{id:3,titleEn:'Life on the Space Station',titleCn:'空间站上的生活',
words:[{en:'weightless',cn:'失重的'},{en:'exercise',cn:'锻炼'},{en:'sleeping bag',cn:'睡袋'},{en:'space food',cn:'太空食品'},{en:'spacewalk',cn:'太空行走'}],
text:[
...
words:[{en:'partner',cn:'合作伙伴'},{en:'spacecraft',cn:'航天器'},{en:'Dragon',cn:'龙飞船'},{en:'Soyuz',cn:'联盟号'},{en:'collaborate',cn:'合作'}],
text:[
...
words:[{en:'fact',cn:'事实'},{en:'wiring',cn:'线路'},{en:'computer',cn:'计算机'},{en:'vaccine',cn:'疫苗'},{en:'research',cn:'研究'}],
text:[
{en:'The ISS has about 8 miles of electrical wiring running through it!',cn:'国际空间站里有大约8英里长的电线！'},
{en:'Over 50 computers keep all the station systems running smoothly.',cn:'超过50台计算机保持空间站所有系统顺利运行。'},
...
words:[{en:'Moon',cn:'月球'},{en:'Mars',cn:'火星'},{en:'explore',cn:'探索'},{en:'discover',cn:'发现'},{en:'mission',cn:'任务'}],
text:[
...
let currentBook=null,currentLesson=1,fontSize=16,speechRate=0.35;
...
const u=new SpeechSynthesisUtterance(_cleanText(word,'en'));
...
if(!window.speechSynthesis)return;
window.speechSynthesis.cancel();
const raw=el.getAttribute('data-text'),lang=el.getAttribute('data-lang'),clean=_cleanText(raw,lang);
if(!clean)return;
const u=new SpeechSynthesisUtterance(clean);
u.lang=lang==='en'?'en-US':'zh-CN';
u.rate=Math.max(0.3,lang==='en'?speechRate*0.85:speechRate*0.9);
u.pitch=lang==='en'?1.15:1.1;
...
if(!window.speechSynthesis)return;
window.speechSynthesis.cancel();
const paras=document.querySelectorAll('#'+(lang==='en'?'enBody':'cnBody')+' .text-paragraph');
if(!paras.length)return;
let txt='';
paras.forEach(p=>{const c=_cleanText(p.getAttribute('data-text'),lang);if(c)txt+=c+' ';});
...
<div class="book-title">${currentBook.titleCn}</div>
<div class="nav-controls">
<select class="lesson-select" id="ls">${currentBook.lessons.map(l=>'<option value="'+l.id+'">'+l.titleEn+' / '+l.titleCn+'</option>').join('')}</select>
<button class="nav-btn" id="thBtn"><i class="fas fa-moon"></i></button>
</div>
</nav>
<div class="progress-bar-container"><div class="progress-bar" id="pb"></div></div>
<div class="reader-page"><div class="reader-content" id="rc"></div></div>
<div class="reader-footer">
<button class="footer-nav-btn" id="prevBtn"><i class="fas fa-chevron-left"></i> 上一课</button>
<span id="pt">${currentLesson} / ${TOTAL}</span>
<button class="footer-nav-btn" id="nextBtn">下一课 <i class="fas fa-chevron-right"></i></button>
</div>`;

document.getElementById('ls').value=currentLesson;
document.getElementById('ls').addEventListener('change',function(){go(parseInt(this.value));});
document.getElementById('thBtn').addEventListener('click',function(){document.body.classList.toggle('light-theme');localStorage.setItem('nasa_th',document.body.classList.contains('light-theme')?'light':'dark');});
if(localStorage.getItem('nasa_th')==='light')document.body.classList.add('light-theme');
document.getElementById('prevBtn').addEventListener('click',()=>{if(currentLesson>1)go(currentLesson-1);});
document.getElementById('nextBtn').addEventListener('click',()=>{if(currentLesson<TOTAL)go(currentLesson+1);});
...
renderLesson(n);
window.scrollTo(0,0);
history.replaceState(null,'',new URL(window.location).searchParams.set('lesson',n));
}

function renderLesson(id){
const l=currentBook.lessons.find(x=>x.id===id),TOTAL=currentBook.lessons.length;
if(!l)return;
let h='<div class="lesson-header"><div class="lesson-number">'+l.titleEn+'</div><div class="lesson-title">'+l.titleEn+'</div><div class="lesson-title-cn">'+l.titleCn+'</div></div>';
if(l.words&&l.words.length)h+='<div class="words-section"><div class="words-label">生词</div><div class="words-grid">'+l.words.map(w=>'<div class="word-tag" onclick="_speakWord(\x27'+w.en+'\x27)"><span class="word-en">'+w.en+'</span><span class="word-cn">'+w.cn+'</span></div>').join('')+'</div></div>';
h+='<div class="bilingual-layout"><div class="lang-column"><div class="lang-header en">English <button class="speak-all-btn" onclick="_speakAll(\x27en\x27)"><i class="fas fa-volume-up"></i></button></div><div class="lang-body" id="enBody">'+l.text.map((t,i)=>'<div class="text-paragraph" data-idx="'+i+'" data-lang="en" data-text="'+t.en.replace(/"/g,'&quot;')+'"><span class="para-text">'+t.en+'</span><button class="para-speak" onclick="_speakPara(this.parentElement)"><i class="fas fa-volume-up"></i></button></div>').join('')+'</div></div><div class="lang-column"><div class="lang-header cn">中文 <button class="speak-all-btn" onclick="_speakAll(\x27cn\x27)"><i class="fas fa-volume-up"></i></button></div><div class="lang-body" id="cnBody">'+l.text.map((t,i)=>'<div class="text-paragraph" data-idx="'+i+'" data-lang="cn" data-text="'+t.cn.replace(/"/g,'&quot;')+'"><span class="para-text">'+t.cn+'</span><button class="para-speak" onclick="_speakPara(this.parentElement)"><i class="fas fa-volume-up"></i></button></div>').join('')+'</div></div></div>';
document.getElementById('rc').innerHTML=h;
document.getElementById('pb').style.width=(id/TOTAL*100)+'%';
document.getElementById('pt').textContent=id+' / '+TOTAL;
document.getElementById('prevBtn').disabled=id<=1;
document.getElementById('nextBtn').disabled=id>=TOTAL;
}
